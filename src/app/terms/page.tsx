...
export const metadata = buildMetadata({
  title: "Terms of use",
  description: truncateForMeta("Terms of use for the Dallas-Fort Worth emergency plumbing service request website, outlining how the provider connection service works."),
  path: "/terms"
});
