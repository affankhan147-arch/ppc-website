      ...
      <div className="page-shell">
        <div className="premium-card max-w-4xl mx-auto">
          ...
          <section className="mb-10">
            ...
            <p className="text-slate-300 mb-4">
              DFW homeowners often treat hard freezes as a once-a-decade fluke. The <a href="https://www.weather.gov/fwd/dsnows" target="_blank" rel="noopener noreferrer" className="text-[#F0B429] underline">National Weather Service Fort Worth office's own historical record of significant regional snow and ice events</a>, spanning 1841 through 2025, tells a different story: the frequency of documented major winter events has been climbing, not staying flat. Recent decades average roughly two to four major events per decade, and the 21st century alone has already produced at least 18 separately documented significant snow, ice, or freeze events in the DFW area - including three separate events in the year 2000 alone and three more in 2010.
            </p>
            <p className="text-slate-300 mb-4">
          ...
          <section className="mb-10">
            ...
            <p className="text-slate-400 text-sm mt-4">
              <strong>Sources:</strong> Water hardness data compiled from municipal water utility reports and regional water-treatment provider field testing (2023-2024); <a href="https://www.weather.gov/fwd/dsnows" target="_blank" rel="noopener noreferrer" className="text-[#F0B429] underline">National Weather Service Fort Worth/Dallas office historical winter weather event records</a>; <a href="https://www.dallasfed.org/research/indicators/dfw" target="_blank" rel="noopener noreferrer" className="text-[#F0B429] underline">Federal Reserve Bank of Dallas regional economic indicators (2025)</a>; Texas Department of Insurance and Groundworks Winter Storm Uri survey data (cited in full in our burst pipes guide).
            </p>
          </section>
