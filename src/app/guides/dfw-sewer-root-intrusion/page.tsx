      ...
      <div className="page-shell">
        <div className="premium-card max-w-4xl mx-auto">
          ...
          <section className="mb-10">
            ...
            <p className="text-slate-300 mb-4">
              Local municipalities are clear about responsibility. The <a href="https://codelibrary.amlegal.com/codes/dallas/latest/dallas_tx/0-0-0-125444" target="_blank" rel="noopener noreferrer" className="text-[#F0B429] underline">City of Dallas's code (Sec. 49-24, Service Connections)</a> states the city is responsible for maintenance of the service connection from the main to the property line for wastewater service; the sewer lateral and other private plumbing are the homeowner's responsibility. <a href="https://www.fortworthtexas.gov/departments/neighborhoods/services/priority-repair" target="_blank" rel="noopener noreferrer" className="text-[#F0B429] underline">Fort Worth offers a Priority Repair Program</a> for income‑eligible homeowners facing emergency sewer repairs, and <a href="https://www.arlingtontx.gov/cms/one.aspx?pageId=14973369" target="_blank" rel="noopener noreferrer" className="text-[#F0B429] underline">Arlington Water Utilities</a> covers structural failures specifically within the public right‑of‑way.
            </p>
