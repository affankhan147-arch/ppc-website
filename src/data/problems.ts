...
export const problems: Problem[] = [
  ...
  },
  {
    ...
    steps: ["If you smell gas strongly or continuously, leave the house and call 911 or your gas utility from outside - do not use light switches, phones, or open flames indoors.", "Turn off water to the heater.", "Turn off breaker or gas if safe.", "Keep clear of standing water.", "Request water heater help."],
  ...
  },
  {
    ...
    steps: ["If you smell gas strongly or continuously, leave the house and call 911 or your gas utility from outside - do not use light switches, phones, or open flames indoors.", "Check for visible leaks.", "Do not relight gas if you smell gas.", "Check breaker only if safe.", "Request water heater guidance."],
