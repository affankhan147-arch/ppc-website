...
export const services: Service[] = [
  {
    ...
    shortAnswer: "If water is leaking, a drain is backing up, or a fixture cannot be used safely, shut off the closest valve and request urgent plumbing help.",
    urgency: "High",
  ...
  },
  {
    ...
    shortAnswer: "Emergency drain cleaning is needed when wastewater backs up, more than one fixture is affected, or a clog blocks a kitchen, bathroom, or business.",
    urgency: "High",
  ...
  },
  {
    ...
    categorySlug: "emergency-plumbing",
    shortAnswer: "Businesses should call quickly when plumbing stops operations, affects customers, or risks property damage, since downtime and code compliance matter.",
    urgency: "High",
  ...
  },
  {
    ...
    categorySlug: "emergency-plumbing",
    shortAnswer: "A same-day plumber connection routes urgent non-life-safety plumbing needs to available local providers for issues that need prompt attention.",
    urgency: "Medium",
