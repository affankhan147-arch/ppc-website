...
export const services: Service[] = [
  ...
  },
  {
    ...
    categorySlug: "emergency-plumbing",
    shortAnswer: "Fast emergency plumbing without breaking budget.",
    urgency: "High",
    symptoms: ["active water leak", "backed-up drain", "no hot water"],
    steps: ["Shut off water", "Locate problem", "Call for service"],
    callPrep: ["Type of emergency", "Affected fixture", "ZIP code"],
    commonCauses: ["burst pipes", "drain blockage", "fixture failure"],
    mistakesToAvoid: ["Do not ignore leaks", "Do not wait for business hours"],
    costDiscussion: "Emergency plumbing costs vary by problem type.",
    costFactors: ["problem type", "access difficulty", "parts needed"],
    faqSeed: ["How much does emergency plumbing cost?", "Can you come same day?"]
  },
  {
    slug: "same-day-emergency-plumber-dfw",
    name: "Same-Day Emergency Plumber DFW",
    categorySlug: "emergency-plumbing",
    shortAnswer: "Available for same-day emergency repairs across DFW.",
    urgency: "High",
    symptoms: ["water leaking", "burst pipe", "no hot water"],
    steps: ["Stop water source", "Avoid fixtures", "Call immediately"],
    callPrep: ["Exact location", "How long existing", "Fixtures affected"],
    commonCauses: ["pipe burst", "sewer backup", "water heater failure"],
    mistakesToAvoid: ["Do not delay calling", "Do not use water until diagnosed"],
    costDiscussion: "Same-day service includes response time and urgency factors.",
    costFactors: ["response time", "after-hours premium", "parts and labor"],
    faqSeed: ["Do you charge extra for same-day?", "How fast can you arrive?"]
  },
  {
    slug: "toilet-backup-emergency-repair-dallas",
    name: "Toilet Backup Emergency Repair Dallas",
    categorySlug: "toilet-emergency",
    shortAnswer: "Fast emergency toilet repair for overflows and blockages.",
    urgency: "High",
    symptoms: ["toilet overflowing", "won't stop running", "water level rising"],
    steps: ["Turn off supply valve", "Do not flush again", "Call for help"],
    callPrep: ["How long problem existed", "Constant or occasional"],
    commonCauses: ["internal flapper failure", "clog in trap", "fill valve malfunction"],
    mistakesToAvoid: ["Do not keep flushing", "Do not ignore rising water"],
    costDiscussion: "Toilet repair depends on simple replacement vs deeper clog.",
    costFactors: ["repair vs replacement", "clog location", "drain access"],
    faqSeed: ["Is my toilet fixable or new?", "Why does it keep running?"]
  },
  {
    slug: "water-heater-not-heating-emergency-service",
    name: "Water Heater Not Heating Emergency Service",
    categorySlug: "water-heater-emergency",
    shortAnswer: "Emergency water heater repair or replacement when no hot water.",
    urgency: "High",
    symptoms: ["no hot water at all", "water comes out cold", "tank leaking"],
    steps: ["Check pilot light on gas units", "Check breaker on electric", "Shut off if leaking"],
    callPrep: ["Age of water heater", "Whether it leaks", "Type (gas or electric)"],
    commonCauses: ["failed heating element", "burst tank", "thermostat failure"],
    mistakesToAvoid: ["Do not ignore leaks", "Do not smell for gas leaks"],
    costDiscussion: "Water heater repair or replacement cost depends on unit condition.",
    costFactors: ["repair vs replacement", "unit size", "efficiency rating"],
    faqSeed: ["Is repair cheaper than replace?", "How long do they last?"]
  },
  {
    slug: "burst-pipe-emergency-what-to-do-first",
    name: "Burst Pipe Emergency - What To Do First",
    categorySlug: "burst-pipe-emergency",
    shortAnswer: "Learn first steps when pipe bursts, then call for emergency repair.",
    urgency: "High",
    symptoms: ["water spraying from pipe", "active leak under sink", "water from ceiling"],
    steps: ["Shut off main water valve immediately", "Turn off electricity if needed", "Move valuables"],
    callPrep: ["Exact location of burst", "How much water leaked", "Electrical areas wet"],
    commonCauses: ["frozen pipe", "corrosion failure", "high water pressure"],
    mistakesToAvoid: ["Do not wait to shut water", "Do not leave leaks unattended"],
    costDiscussion: "Burst pipe repair cost depends on location and access method.",
    costFactors: ["pipe location", "pipe material", "water damage cleanup"],
    faqSeed: ["How do I find main shutoff?", "What causes burst pipes?"]
  }
];
