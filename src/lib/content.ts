...
export function getAllInventoryPages(): InventoryPage[] {
  const guidePages: InventoryPage[] = [
    ...
    { kind: "guide", title: "DFW Plumbing Emergency Data Report", path: "/guides/dfw-plumbing-data", h1: "DFW Plumbing Emergency Data", description: "An original, sourced data report on Dallas-Fort Worth water hardness by city, winter freeze-event frequency, and the population growth driving local plumbing demand." },
    { kind: "guide", title: "Free DFW Plumbing Tools & Embeddable Widgets", path: "/tools", h1: "Free DFW Plumbing Tools & Embeddable Widgets", description: "Free tools and embeddable data widgets for Dallas-Fort Worth homeowners, real estate agents, and local site owners." },
    { kind: "guide", title: "Free DFW Water Hardness Widget", path: "/tools/water-hardness-widget", h1: "Free DFW Water Hardness Widget", description: "A free, embeddable water hardness badge for DFW-area cities, sourced from real municipal water utility data." },
    { kind: "guide", title: "Free DFW Plumbing Data Badges", path: "/tools/dfw-data-badges", h1: "Free DFW Plumbing Data Badges", description: "Free, embeddable badges for DFW winter freeze risk, population growth, and water heater lifespan - sourced from real, cited data." },
    { kind: "guide", title: "Free DFW Freeze Watch Widget", path: "/tools/freeze-watch-widget", h1: "Free DFW Freeze Watch Widget", description: "A free, live-updating freeze-risk badge for Dallas-Fort Worth, sourced directly from the National Weather Service forecast." },
    { kind: "guide", title: "Free DFW Cost Guide Checklist Badges", path: "/tools/cost-guide-checklists", h1: "Free DFW Cost Guide Checklist Badges", description: "Free, embeddable badges showing how many key questions to ask before you approve emergency plumbing work in DFW, by issue type." },
    { kind: "guide", title: "DFW Emergency Plumbing Cost Guides", path: "/cost-guides", h1: "DFW Emergency Plumbing Cost Guides", description: "Six plain-language cost guides covering what affects emergency plumbing pricing in Dallas-Fort Worth and what to ask before you approve work." },
    { kind: "guide", title: "DFW Homeowner Plumbing Problem Guides", path: "/problems", h1: "DFW Homeowner Plumbing Problem Guides", description: "Plain-language guides for common DFW plumbing emergencies - warning signs, first steps, what not to do, and when it becomes urgent." },
    { kind: "guide", title: "Free DFW Emergency Warning-Sign Checklist Badges", path: "/tools/problem-checklists", h1: "Free DFW Emergency Warning-Sign Checklist Badges", description: "Free, embeddable badges highlighting the warning signs for common DFW plumbing emergencies - burst pipes, sewer backups, water heater leaks, and more." },
